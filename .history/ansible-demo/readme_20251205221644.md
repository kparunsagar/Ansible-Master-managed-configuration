...
[Managed Nodes]
machine1 ansible_host=<slave1-public-ip> ansible_user=azureuser
machine2 ansible_host=<slave2-public-ip> ansible_user=azureuser
machine3 ansible_host=<slave3-public-ip> ansible_user=azureuser
...
│           └── main.yml
├── group_vars/
│   └── slaves.yml       # Variables for all managed server hosts
